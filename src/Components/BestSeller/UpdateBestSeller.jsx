...
const UpdateBestSeller = () => {
    ...
    const postData = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(`https://api.myriccoproducts.com/api/bestseller/`+_id, formData)
            console.log(res)
            if (res.status === 200) {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get(`https://api.myriccoproducts.com/api/bestseller/`+_id)
